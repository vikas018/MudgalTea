...
const WhatsAppOrderButton = ({ productName, variant, className = '' }: WhatsAppOrderButtonProps) => {
  ...
  return (
    <a
      ...
      className={`inline-flex items-center justify-center gap-2 bg-green-700 text-white px-4 py-2 rounded hover:bg-green-600 transition duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 ${className}`}
    >
